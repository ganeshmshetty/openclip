...
TRANSLATIONS: dict[str, str] = {
    ...
    "Translate": "翻译",
    "Translate the text accurately into natural English": "将文本准确翻译成自然流畅的中文",
    "Fix Code": "修复代码",
    ...
    "So OpenClip can see what you've selected — nothing is sent anywhere.": "这样 OpenClip 才能看到你选中的内容 — 不会发送到任何地方。",
    "100% Private & On-Device": "100% 隐私，全部在本机完成",
    "Your highlighted text never leaves your Mac. OpenClip runs entirely locally and never collects or transmits data.": "你选中的文本不会离开这台 Mac。OpenClip 完全在本地运行，从不收集或传输数据。",
    ...
    "Highlighted text stays strictly on your Mac and is never collected or sent over the network.": "选中的文本只会留在你的 Mac 上，不会被收集或通过网络发送。",
