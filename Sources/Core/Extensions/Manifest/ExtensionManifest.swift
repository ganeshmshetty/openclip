...
public struct ExtensionMetadata: Sendable, Codable, Equatable {
    ...
    public let openClipVersion: String?
    ...
    public init(
        ...
        self.openClipVersion = openClipVersion
    }
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.openClipVersion = try container.decodeIfPresent(String.self, forKey: .openClipVersion)
    }
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(openClipVersion, forKey: .openClipVersion)
    }
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case openClipVersion = "openClipVersion"
    }
}
