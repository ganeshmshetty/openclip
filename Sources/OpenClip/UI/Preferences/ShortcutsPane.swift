...
// fifteen popovers.
//
// This is the page Vorssaint calls Keyboard shortcuts: every installed feature's global shortcut on
// one categorized page, so bindings are set where they can be compared. The per-action page keeps
// its own copy of the same two fields — a binding is legitimately part of the action *and* part of
// the keyboard map, and System Settings duplicates settings across panes for the same reason.
